...
<?php
    ...
    $mpk_use = array( 0, 323,324,325,326,327,328,329,353,357,361);
    $mpk_acc = array( 0, 301,304,307,310,313,316,319,354,358,362);
    $mpk_lbl = array( 0, 302,305,308,311,314,317,320,355,359,363);
    $mpk_val = array( 0, 303,306,309,312,315,318,321,356,360,364);

    $product_file = PROV_PATH . '/' . PROV_GS . '/' . 'cfggrp2604p.xml';
...
<gs_provision version="1">
  <config version="1">
    <P148>Grandstream GRP2604P</P148>
EOT;
            $content .= "\n";
